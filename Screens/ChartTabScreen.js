...
function ChartTabScreen({ route }) {
    return (
        <Tab.Navigator screenOptions={{ tabBarShowLabel: false, headerTintColor: "#005390", headerTitleAlign: "center"}}>
            ...
            <Tab.Screen name="MonthlyChartScreen" component={MonthlyChartScreen} options={{headerTitleStyle: { fontSize: 35, fontWeight: "700" }, title:"پچھلے 30 دنوں کا گراف", tabBarIcon: ({ color }) => <View style={{width:40,height:40,backgroundColor:"#fff",elevation:20,borderRadius:20,justifyContent:"center",alignItems:"center",backgroundColor:color}}><Text style={{fontSize:20,fontWeight:"bold"}}>T</Text></View> }}/>
