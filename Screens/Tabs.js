...
function Tabs({route}){
    ...
    return(
       ...
       <Tab.Navigator screenOptions={{tabBarShowLabel:false,headerTintColor:"#005390", headerTitleAlign:"center"}}>
        ...
        <Tab.Screen name="StreakScreen" component={StreakScreen} options={{headerTitleStyle:{fontSize:35,fontWeight:"700"},title:"باقاعدہ نمازوں کی گنتی",tabBarIcon:({color})=><MaterialIcons name="stairs" size={30} color={color} />}}/>
