...
function MonthlyChartScreen() {
    ...
    return (
        <View style={styles.container}>
            <View style={{ backgroundColor: "#fff", height: 550, width: 320, justifyContent: "center", alignItems: "center", elevation: 20, borderRadius: 15, paddingBottom: 21 }}>
                <VictoryChart width={350} height={580} domainPadding={{ x: 20, y: 10 }}  >
                    <VictoryAxis style={{
                        tickLabels: {
                            fontWeight: "bold"
                        }
                    }} ></VictoryAxis>
                    <VictoryAxis tickValues={new Array(30).fill(0).map((item, index) => ++index)} dependentAxis style={{
                        tickLabels: {
                            fontWeight: "bold",
